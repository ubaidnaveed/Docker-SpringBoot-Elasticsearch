...
import com.ubaid.restaurant.exceptions.StorageException;
import com.ubaid.restaurant.services.StorageService;
    ...
    public String store(MultipartFile file, String filename) {
        try {
            ...
            if (!destinationFile.getParent().equals(rootLocation.toAbsolutePath())) {
                throw new StorageException("Can not save file in an another directory.");
            }
            ...
            throw new StorageException("Couldn't initialize storage location", e);
        }
    }
